...
Games <- rbind(KobeBryant_G, JoeJohnson_G, LeBronJames_G, 
               CarmeloAnthony_G, DwightHoward_G, ChrisBosh_G, ChrisPaul_G,KevinDurant_G, 
               DerrickRose_G, DwayneWade_G)
rm(KobeBryant_G, JoeJohnson_G, CarmeloAnthony_G, DwightHoward_G, 
   ChrisBosh_G, LeBronJames_G, ChrisPaul_G, DerrickRose_G, DwayneWade_G, KevinDurant_G)
...
Points <- rbind(KobeBryant_PTS, JoeJohnson_PTS, LeBronJames_PTS, 
                CarmeloAnthony_PTS, DwightHoward_PTS, ChrisBosh_PTS, ChrisPaul_PTS, 
                KevinDurant_PTS, DerrickRose_PTS, DwayneWade_PTS)
...
field_goals <- rbind(KobeBryant_FGA, JoeJohnson_FGA, LeBronJames_FGA, 
...
#visualizing the FreeThrowAccuracy with a plot
...
legend("topright",inset=0.01,legend=Players,col=c(1:10,2),pch=(10:15),
       horiz=F, ncol = 2,cex = 0.3)

# visualizing the FreeThrowAttemptPerGame with a plot
...
# visualizing the 2 pointers per game
matplot(t(point_game_2),type="b",pch=(10:15),col=c(1:10,2))
legend("topright",inset=0.01,legend=Players,col=c(1:10,2),pch=(10:15),
       horiz=F, ncol = 2,cex = 0.3)
# visualizing the 3 pointers per game
